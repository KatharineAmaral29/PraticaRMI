...
public class P4 extends Thread implements P {
	...
	public static void main(String args[]) throws RemoteException {
		...
		P4 no4 = new P4();
		stub = (P) UnicastRemoteObject.exportObject(no4, 0);
		reg = null;
		try {
			System.out.println("P4 esta no ar!");
...
//		}
		...
		if (pid.equals(this.pid)) {
			System.out.println("Processo P4 ("+this.pid+") iniciou a eleicao");
	...
	public void setLeader(String pid) throws RemoteException {
		...
		if (pid.equals(this.pid)) {
			...
			System.out.println("Eu, P4(" + pid + "), sou o novo coordenador!");
		} else {
